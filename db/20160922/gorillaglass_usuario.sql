...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `fk_tipoUsuario` FOREIGN KEY (`idTipo`) REFERENCES `tipoUsuario` (`idTipoUsuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `usuario` VALUES (15,1,'Santiago Altamirano','Hugo Luis','hugooluisss@gmail.com','k0rgk0rg');
